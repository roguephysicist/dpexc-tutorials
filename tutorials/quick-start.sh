...
mpiexec -np 12 -env I_MPI_DEVICE rdssm  /home/sma/abinit-5.7.3_etsf/src/main/abinip < si_kss_gen.files > si_kss_gen.log
rm *_DDB *_DEN *_EIG *_WFK *_LOG*
ln -sf sio_DS2_KSS si.kss
$HOME/dpforexc/src/dp-5.3.99-openmp -i dp_rpa.in -k si.kss > dp_rpa.log
...
$HOME/dpforexc/src/dp-5.3.99-openmp -i dp_tdlda.in -k si.kss > dp_tdlda.log
...
ln -sf ../dp01-rpa_si/sio_DS2_KSS si.kss
$HOME/dpforexc/src/dp-5.3.99-openmp -i dp_alpha.in -k si.kss > dp_alpha.log
rm gmon.out *.kdotp* fort.*
cd ..

cd exc01-prep/
printf "Running EXC Tutorial 1\n"
mpiexec -np 12 -env I_MPI_DEVICE rdssm  /home/sma/abinit-5.7.3_etsf/src/main/abinip < si_gen.files > si_gen.log
...
$HOME/dpforexc/src/dp-5.3.99-openmp -i exc01_rpa.in -k si_converged.kss > exc01_rpa.log
...
$HOME/dpforexc/src/dp-5.3.99-openmp -i exc02_gwrpa.in -k si_converged.kss > exc02_gwrpa.log
...
$HOME/dpforexc/src/dp-5.3.99-openmp -i exc03_exc.in -k si.kss -s si.scr > exc03_exc.log
